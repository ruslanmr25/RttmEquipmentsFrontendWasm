...
var randomizeArray = function (e) {
     for (var t, o, a = e.slice(), r = a.length; 0 !== r;)
          (o = Math.floor(Math.random() * r)), (t = a[--r]), (a[r] = a[o]), (a[
               o
          ] = t);
     return a;
},
...
options = {
     chart: {
          height: 380,
          type: 'line',
          shadow: { enabled: !1, color: '#bbb', top: 3, left: 2, blur: 3, opacity: 1 },
     },
...
function generateDayWiseTimeSeries(e, t, o) {
     for (var a = 0, r = []; a < t;) {
          var s = e, i = Math.floor(Math.random() * (o.max - o.min + 1)) + o.min;
...
(colors = ['#1abc9c', '#f672a7', '#6c757d', '#6658dd', '#6559cc']), (options = {
